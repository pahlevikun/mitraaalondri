...
public class Order {
    ...
    private String id, idOrder, user_id, kurir_id, mitra_id, nama_jalan, nama_alias, phone_alias, invoice_number,
            ...
            waktu_mulai, waktu_akhir, is_byitem;

    public Order() {
    }

    public Order(String id, String idOrder, String user_id, String kurir_id, String mitra_id, String nama_jalan, String nama_alias, String phone_alias,
